...
`wmi_terminal_services_percent_privileged_time` | Percentage of elapsed time that the threads of the process have spent executing code in privileged mode. | gauge | `session_name`
`wmi_terminal_services_percent_processor_time` | Percentage of elapsed time that all of the threads of this process used the processor to execute instructions. | gauge | `session_name`
`wmi_terminal_services_percent_user_time` | Percentage of elapsed time that this process's threads have spent executing code in user mode. Applications, environment subsystems, and integral subsystems execute in user mode. | gauge | `session_name`
