...
func (c *Collector) buildSQLStats() error {
	...
	for _, sqlInstance := range c.mssqlInstances {
		c.sqlStatsPerfDataCollectors[sqlInstance.name], err = pdh.NewCollector[perfDataCounterValuesSqlStats](pdh.ResultTypeRaw, c.mssqlGetPerfObjectName(sqlInstance.name, "SQL Statistics"), nil)
		if err != nil {
