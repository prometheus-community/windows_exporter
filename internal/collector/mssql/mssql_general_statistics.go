...
func (c *Collector) buildGeneralStatistics() error {
	...
	for _, sqlInstance := range c.mssqlInstances {
		c.genStatsPerfDataCollectors[sqlInstance.name], err = pdh.NewCollector[perfDataCounterValuesGenStats](pdh.ResultTypeRaw, c.mssqlGetPerfObjectName(sqlInstance.name, "General Statistics"), nil)
		if err != nil {
