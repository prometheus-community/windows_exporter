...
func (c *Collector) Build(_ *slog.Logger, _ *mi.Session) error {
	...
	c.perfDataCollector4, err = pdh.NewCollector[perfDataCounterValues](pdh.ResultTypeRaw, "UDPv4", nil)
	if err != nil {
		return fmt.Errorf("failed to create UDPv4 collector: %w", err)
	}

	c.perfDataCollector6, err = pdh.NewCollector[perfDataCounterValues](pdh.ResultTypeRaw, "UDPv6", nil)
	if err != nil {
