...
func (c *Collector) buildADAccessProcesses() error {
	...
	c.perfDataCollectorADAccessProcesses, err = pdh.NewCollector[perfDataCounterValuesADAccessProcesses](pdh.ResultTypeRaw, "MSExchange ADAccess Processes", pdh.InstancesAll)
	if err != nil {
