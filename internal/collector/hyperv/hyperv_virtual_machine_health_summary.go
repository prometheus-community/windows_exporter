...
func (c *Collector) buildVirtualMachineHealthSummary() error {
	...
	c.perfDataCollectorVirtualMachineHealthSummary, err = pdh.NewCollector[perfDataCounterValuesVirtualMachineHealthSummary](pdh.ResultTypeRaw, "Hyper-V Virtual Machine Health Summary", nil)
	if err != nil {
