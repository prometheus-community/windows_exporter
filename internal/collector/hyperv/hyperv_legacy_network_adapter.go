...
func (c *Collector) buildLegacyNetworkAdapter() error {
	...
	c.perfDataCollectorLegacyNetworkAdapter, err = pdh.NewCollector[perfDataCounterValuesLegacyNetworkAdapter](pdh.ResultTypeRaw, "Hyper-V Legacy Network Adapter", pdh.InstancesAll)
	if err != nil {
