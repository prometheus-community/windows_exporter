...
func (c *Collector) buildHypervisorRootVirtualProcessor() error {
	...
	c.perfDataCollectorHypervisorRootVirtualProcessor, err = pdh.NewCollector[perfDataCounterValuesHypervisorRootVirtualProcessor](pdh.ResultTypeRaw, "Hyper-V Hypervisor Root Virtual Processor", pdh.InstancesAll)
	if err != nil {
