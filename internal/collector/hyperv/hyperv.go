...
func (c *Collector) collectVmHealth(ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_VmmsVirtualMachineStats_HyperVVirtualMachineHealthSummary"); err != nil {
...
func (c *Collector) collectVmVid(ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_VidPerfProvider_HyperVVMVidPartition"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectVmHv(ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_HvStats_HyperVHypervisorRootPartition"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectVmProcessor(ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_HvStats_HyperVHypervisor"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectHostLPUsage(logger *slog.Logger, ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_HvStats_HyperVHypervisorLogicalProcessor"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectHostCpuUsage(logger *slog.Logger, ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_HvStats_HyperVHypervisorRootVirtualProcessor"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectVmCpuUsage(logger *slog.Logger, ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectVmSwitch(ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_NvspSwitchStats_HyperVVirtualSwitch"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectVmEthernet(ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_EthernetPerfProvider_HyperVLegacyNetworkAdapter"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectVmStorage(ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_Counters_HyperVVirtualStorageDevice"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectVmNetwork(ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_NvspNicStats_HyperVVirtualNetworkAdapter"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
...
func (c *Collector) collectVmMemory(ch chan<- prometheus.Metric) error {
	...
	if err := c.miSession.Query(&dst, mi.NamespaceRootCIMv2, "SELECT * Win32_PerfRawData_BalancerStats_HyperVDynamicMemoryVM"); err != nil {
		return fmt.Errorf("WMI query failed: %w", err)
	}
