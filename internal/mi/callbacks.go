...
var operationUnmarshalCallbacksInstanceResult = windows.NewCallback(func(
	operation *Operation,
...
func NewOperationUnmarshalCallbacks(dst any, errCh chan<- error) (*OperationUnmarshalCallbacks, error) {
	...
	return &OperationUnmarshalCallbacks{
		errCh:     errCh,
		dst:       dst,
		dv:        dv,
		elemType:  elemType,
