...
$exporter_proc = Start-Process `
    ...
    -ArgumentList '--web.listen-address="127.0.0.1:9183" --log.level=debug --collectors.enabled=[defaults],cpu_info,textfile,process,scheduled_task,tcp,udp,update,time,system,service,logical_disk,printer,os,net,memory,logon,cache'`
    -WindowStyle Hidden `
